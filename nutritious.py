...
class NutritiousDataset(utils.Dataset):

    def load_data_object(self, dataset_dir, subset):
        """Load a subset of the Nutritious dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # for now only 1 class
